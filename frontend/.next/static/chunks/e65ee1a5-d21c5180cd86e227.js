"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[743],{9290:function(e,t,r){r.d(t,{p:function(){return getAuth}});var i=r(3310),n=r(9711),s=r(4645),a=r(75);function _prodErrorMap(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}let o=_prodErrorMap,l=new n.LL("auth","Firebase",_prodErrorMap()),c=new s.Yd("@firebase/auth");function _logWarn(e,...t){c.logLevel<=s.in.WARN&&c.warn(`Auth (${i.Jn}): ${e}`,...t)}function _logError(e,...t){c.logLevel<=s.in.ERROR&&c.error(`Auth (${i.Jn}): ${e}`,...t)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let k=new Delay(3e4,6e4);function resetUnloadedGapiModules(){let e=_window().___jsl;if(e?.H){for(let t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}}function loadGapi(e){return new Promise((t,r)=>{function loadGapiIframe(){resetUnloadedGapiModules(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{resetUnloadedGapiModules(),r(_createError(e,"network-request-failed"))},timeout:k.get()})}if(_window().gapi?.iframes?.Iframe)t(gapi.iframes.getContext());else if(_window().gapi?.load)loadGapiIframe();else{var i;let t=_generateCallbackName("iframefcb");return _window()[t]=()=>{gapi.load?loadGapiIframe():r(_createError(e,"network-request-failed"))},(i=`${_gapiScriptUrl()}?onload=${t}`,f.loadJS(i)).catch(e=>r(e))}}).catch(e=>{throw A=null,e})}let A=null;function _loadGapi(e){return A=A||loadGapi(e)}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
